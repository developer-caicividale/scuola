package it.caicividale.corsicai.ui.parts.treeviewer.labelproviders;
...
public class TreeviewCorsiLabelProvider extends LabelProvider {
    ...
    public TreeviewCorsiLabelProvider() {
