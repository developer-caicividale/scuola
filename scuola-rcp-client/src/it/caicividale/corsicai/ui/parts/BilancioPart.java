...
import it.caicividale.corsicai.ui.parts.tableviewer.labelproviders.BilancioUsciteLabelProvider;
import it.caicividale.corsicai.ui.parts.tableviewer.labelproviders.CasseLabelProvider;
...
public class BilancioPart implements IMyPart {
	...
	private void createBilancioCasse(Composite container) {
		...
		tltmNuovaUscitaBilancio.setImage(
				ResourceManager.getPluginImage("it.caicividale.corsicai.ui", "icons/cassaforte_add24x24.png"));

		ToolItem tltmModificaUscitaBilancio = new ToolItem(toolBar, SWT.NONE);
		tltmModificaUscitaBilancio.setImage(
				ResourceManager.getPluginImage("it.caicividale.corsicai.ui", "icons/cassaforte_modifica24x24.png"));
		...
		tltmCancellaUscitaBilancio.setImage(
				ResourceManager.getPluginImage("it.caicividale.corsicai.ui", "icons/cassaforte_remove24x24.png"));
	...
	private void createBilancioUscite(Composite container) {
		...
		tltmNuovaUscitaBilancio.setImage(
				ResourceManager.getPluginImage("it.caicividale.corsicai.ui", "icons/bilancio_uscita_add24x24.png"));

		ToolItem tltmModificaUscitaBilancio = new ToolItem(toolBar, SWT.NONE);
		tltmModificaUscitaBilancio.setImage(ResourceManager.getPluginImage("it.caicividale.corsicai.ui",
				"icons/bilancio_uscita_modifica24x24.png"));
		tltmModificaUscitaBilancio.setToolTipText("Modifica uscita");

		ToolItem tltmCancellaUscitaBilancio = new ToolItem(toolBar, SWT.NONE);
		tltmCancellaUscitaBilancio.setImage(
				ResourceManager.getPluginImage("it.caicividale.corsicai.ui", "icons/bilancio_uscita_remove24x24.png"));
		tltmCancellaUscitaBilancio.setToolTipText("Cancella uscita");
		...
		tltmNuovaUscitaBilancio.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				ParameterizedCommand command = commandService.createCommand(
						"it.caicividale.corsicai.ui.command.bilancionuovouscita", Collections.emptyMap());
		...
		tltmModificaUscitaBilancio.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				ParameterizedCommand command = commandService.createCommand(
						"it.caicividale.corsicai.ui.command.bilanciomodificauscita", Collections.emptyMap());
				handlerService.executeHandler(command);
			}
		...
		tltmCancellaUscitaBilancio.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				ParameterizedCommand command = commandService.createCommand(
						"it.caicividale.corsicai.ui.command.bilanciocancellauscita", Collections.emptyMap());
				handlerService.executeHandler(command);
			}
	...
	private DataBindingContext bindToModel() {
		...
		IObservableList<RipartizioneCassa> ripartizioneCasseObservableList = EMFProperties.list(FeaturePath
				.fromList(ModelPackage.Literals.CORSO__CASSA, ModelPackage.Literals.CASSA__RIPARTIZIONE_CASSA))
				.observeDetail(corsoObservable);
