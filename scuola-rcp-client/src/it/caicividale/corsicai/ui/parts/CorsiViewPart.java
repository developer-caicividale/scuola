...
public class CorsiViewPart {
	...
	public void createControls(Composite parent) {
		...
		tbtmIscrizione.setImage(ResourceManager.getPluginImage("it.caicividale.corsicai.ui", "icons/users_male.ico"));
		...
		tbtmLezioniTeoriche.setImage(
				ResourceManager.getPluginImage("it.caicividale.corsicai.ui", "icons/applications_office.ico"));
		...
		tbtmLezioniPratiche.setImage(ResourceManager.getPluginImage("it.caicividale.corsicai.ui", "icons/run_1.ico"));
