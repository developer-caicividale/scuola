...
import org.aspencloud.cdatetime.AbstractCombo;
...
public class DropTestSnippet {
	...
	public static void main(String[] args) {
		...
		final AbstractCombo cdc1 = new CDateTime(shell, CDT.BORDER);
		cdc1.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false));

		final AbstractCombo cdc2 = new CDateTime(shell, CDT.BORDER | CDT.DROP_DOWN);
