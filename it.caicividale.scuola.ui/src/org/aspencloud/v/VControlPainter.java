...
public class VControlPainter implements IControlPainter {
	...
	public static double getX(VControl control, double width) {
		double x;
	...
	public static double getY(VControl control, double height) {
		double y;
	...
	public static void paintImage(VControl control, Event e) {
	...
	public static void paintImageAndText(VControl control, Event e) {
	...
	public static void paintPolygon(VControl control, Event e) {
	...
	public static void paintPolygonAndText(VControl control, Event e) {
		e.gc.setAntialias(SWT.ON);
		e.gc.setTextAntialias(SWT.ON);
		if(control.foreground != null && !control.foreground.isDisposed()) {
			e.gc.setForeground(control.foreground);
	...
	public static void paintText(VControl control, Event e) {
		e.gc.setTextAntialias(SWT.ON);
