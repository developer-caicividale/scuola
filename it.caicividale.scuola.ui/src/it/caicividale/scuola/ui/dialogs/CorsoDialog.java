...
public class CorsoDialog extends Dialog {
	...
	ISWTObservableValue<String> nomeTextObservable = WidgetProperties.text(SWT.Modify).observe(nome);
	...
	ISWTObservableValue<?> isModuloCheckboxObservable = WidgetProperties.buttonSelection()
		.observe(checkBoxIsModulo);
	...
	IObservableValue<LocalDate> dataInizioObservable = EMFProperties
	...
	// data fine
	IObservableValue<LocalDate> dataFineObservable = EMFProperties
	...
	IObservableValue<String> viceDirettoreObservable = EMFProperties
		.value(FeaturePath.fromList(ModelPackage.Literals.CORSO__VICE_DIRETTORE))
