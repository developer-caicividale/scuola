...
import it.caicividale.scuola.ui.databinding.converters.Corso2NumeroAllieviStringConverter;
import it.caicividale.scuola.ui.databinding.converters.Integer2StringConverter;
import it.caicividale.scuola.ui.parts.tableviewer.filters.ElencoIscrizioniFilter;
import it.caicividale.scuola.ui.parts.tableviewer.filters.ElencoIscrizioniKoFilter;
import it.caicividale.scuola.ui.parts.tableviewer.filters.ElencoIscrizioniOkFilter;
import it.caicividale.scuola.ui.parts.tableviewer.labelproviders.ElencoIscrizioniLabelProvider;
import it.caicividale.scuola.ui.parts.tableviewer.labelproviders.RiepilogoMaterialeNoleggiatoLabelProvider;
...
public class ElencoIscrizioniPart implements IMyPart {
	...
	tableViewerElencoIscrizioni.addDoubleClickListener(new IDoubleClickListener() {
		...
		ParameterizedCommand command = commandService
			.createCommand("it.caicividale.scuola.ui.command.modificaiscrizione", Collections.emptyMap());
	...
	tableViewerElencoIscrizioni.addSelectionChangedListener(new ISelectionChangedListener() {
		...
		if (selection != null) {
			...
			if (!structuredSelection.isEmpty()) {
			    Iscrizione iscrizione = (Iscrizione) structuredSelection.getFirstElement();
	...
	// tblclmnAllievo.setImage(ResourceManager.getPluginImage("it.caicividale.scuola.ui",
	// "icons/user32x32.png"));
	...
	// tblclmnModulo.setImage(ResourceManager.getPluginImage("it.caicividale.scuola.ui",
	...
	// tblclmnConsenso.setImage(ResourceManager.getPluginImage("it.caicividale.scuola.ui",
	...
	// tblclmnBollino.setImage(ResourceManager.getPluginImage("it.caicividale.scuola.ui",
	// "icons/Cai32x32.png"));
	...
	// tblclmnDatScadenzaCertificato.setImage(ResourceManager.getPluginImage("it.caicividale.scuola.ui",
	...
	// tblclmnTotale.setImage(ResourceManager.getPluginImage("it.caicividale.scuola.ui",
	// "icons/euro32x32.png"));
	...
	// tblclmnIsNoleggio.setImage(ResourceManager.getPluginImage("it.caicividale.scuola.ui",
	...
	// tblclmnNote.setImage(ResourceManager.getPluginImage("it.caicividale.scuola.ui",
