...
import it.caicividale.scuola.ui.databinding.converters.Corso2ImageConverter;
import it.caicividale.scuola.ui.databinding.converters.Date2StringConverter;
import it.caicividale.scuola.ui.databinding.converters.DizCatalogoCorsi2StringConverter;
...
public class InformazioniCorsoPart {
	...
	IObservableValue<Istruttore> viceDirettoreObservable = EMFProperties
		.value(ModelPackage.Literals.CORSO__VICE_DIRETTORE).observeDetail(corsoObservable);
