...
import it.caicividale.scuola.ui.composites.PersonaComposite;
...
public class PersonaController {
    ...
    private final PersonaComposite personaComposite;
    private final Button okButton;

    private final IObservableValue actualObservable;
	...
	IObservableValue<String> nomeObservable = EMFProperties
		.value(FeaturePath.fromList(ModelPackage.Literals.PERSONA__NOME)).observeDetail(actualObservable);
	ISWTObservableValue nomeTextObservable = WidgetProperties.text(SWT.Modify).observe(personaComposite.getNome());
	...
	IObservableValue<String> cognomeObservable = EMFProperties
		.value(FeaturePath.fromList(ModelPackage.Literals.PERSONA__COGNOME)).observeDetail(actualObservable);
	ISWTObservableValue cognomeTextObservable = WidgetProperties.text(SWT.Modify)
		.observe(personaComposite.getCognome());
	...
	// sesso
	personaComposite.getSessoViewer().setContentProvider(ArrayContentProvider.getInstance());
	personaComposite.getSessoViewer().setInput(ESesso.values());
	IObservableValue<String> sessoObservable = EMFProperties
		.value(FeaturePath.fromList(ModelPackage.Literals.PERSONA__SESSO)).observeDetail(actualObservable);
	IViewerObservableValue sessoComboObservable = ViewerProperties.singleSelection()
		.observe(personaComposite.getSessoViewer());
	...
	IObservableValue<String> viaObservable = EMFProperties
		...
		.observeDetail(actualObservable);
	ISWTObservableValue viaTextObservable = WidgetProperties.text(SWT.Modify).observe(personaComposite.getVia());
	...
	ISWTObservableValue regioneResidenzaTextObservable = WidgetProperties.text(SWT.Modify)
		.observe(personaComposite.getRegioneResidenza());
	...
	ISWTObservableValue comuneResidenzaTextObservable = WidgetProperties.text(SWT.Modify)
		.observe(personaComposite.getComuneResidenza());
	...
	ISWTObservableValue dataNascitaDateTimeObservable = localDateSelectionDataNascitaProperty
		.observe(personaComposite.getDataNascita());
	...
	ISWTObservableValue regioneNascitaTextObservable = WidgetProperties.text(SWT.Modify)
		.observe(personaComposite.getRegioneNascita());
	...
	ISWTObservableValue comuneNascitaTextObservable = WidgetProperties.text(SWT.Modify)
		.observe(personaComposite.getComuneNascita());
	...
	ISWTObservableValue numeroCellulareTextObservable = WidgetProperties.text(SWT.Modify)
		.observe(personaComposite.getNumeroCellulare());
	...
	IObservableValue<EMail> emailObservable = EMFProperties
		.value(FeaturePath.fromList(ModelPackage.Literals.PERSONA__EMAIL)).observeDetail(actualObservable);
	ISWTObservableValue emailTextObservable = WidgetProperties.text(SWT.Modify)
		.observe(personaComposite.getEmail());
	...
	ISWTObservableValue sezioneTextObservable = WidgetProperties.text(SWT.Modify)
		.observe(personaComposite.getSezione());
	...
	ISWTObservableValue nuovoAllievoCheckboxObservable = WidgetProperties.buttonSelection()
		.observe(personaComposite.getCheckBoxNuovoAllievo());
    ...
    public IObservableValue getActualObservable() {
