...
public class PersonaComposite {
	...
	configureGroupDatiAnagrafici(formData);

	configureGroupDatiResidenza();

	configureGroupDatiNascita();

	configureGroupDatiContatti();

	configureGroupDatiCai();

	return container;

    }

    private void configureGroupDatiCai() {
	FormData formData;
    ...
    private void configureGroupDatiContatti() {
	FormData formData;
    ...
    private void configureGroupDatiNascita() {
	FormData formData;
    ...
    private void configureGroupDatiResidenza() {
	FormData formData;
	// residenza
    ...
    private void configureGroupDatiAnagrafici(FormData formData) {
