...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	 ...
	 * @generated
	 */
	private EClass valutazioneEClass = null;
	 ...
	 * @generated
	 */
	private EEnum eTipoDocumentoEEnum = null;
	 ...
	 * @generated
	 */
	private EDataType dizMateriaValutazioneEDataType = null;
	 ...
	 */
	@Override
	public EReference getAllievo_Valutazioni() {
		return (EReference) allievoEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getCorso_Lezioni() {
		return (EReference) corsoEClass.getEStructuralFeatures().get(3);
	}
	...
	public EAttribute getCorso_IsModulo() {
		return (EAttribute) corsoEClass.getEStructuralFeatures().get(4);
	}
	...
	public EReference getCorso_Segretario() {
		return (EReference) corsoEClass.getEStructuralFeatures().get(7);
	}
	...
	public EAttribute getCorso_Testo() {
		return (EAttribute) corsoEClass.getEStructuralFeatures().get(8);
	}
	...
	public EReference getCorso_Bilancio() {
		return (EReference) corsoEClass.getEStructuralFeatures().get(9);
	}
	...
	public EAttribute getCorso_Id() {
		return (EAttribute) corsoEClass.getEStructuralFeatures().get(10);
	}
	...
	public EReference getCorso_Iscrizioni() {
		return (EReference) corsoEClass.getEStructuralFeatures().get(12);
	}
	...
	public EReference getCorso_StaffIstruttori() {
		return (EReference) corsoEClass.getEStructuralFeatures().get(15);
	}
	...
	public EAttribute getCorso_ListRiepilogonoleggio() {
		return (EAttribute) corsoEClass.getEStructuralFeatures().get(26);
	}
	 ...
	 */
	@Override
	public EAttribute getDocumento_TipoDocumento() {
	 ...
	 */
	@Override
	public EAttribute getDocumento_Documento() {
	 ...
	 */
	@Override
	public EAttribute getDocumento_Id() {
	 ...
	 */
	@Override
	public EReference getIscrizione_Documenti() {
		return (EReference) iscrizioneEClass.getEStructuralFeatures().get(8);
	}
	...
	public EAttribute getIscrizione_IsNoleggio() {
		return (EAttribute) iscrizioneEClass.getEStructuralFeatures().get(11);
	}
	...
	public EReference getIscrizione_MaterialeNoleggiato() {
		return (EReference) iscrizioneEClass.getEStructuralFeatures().get(12);
	}
	...
	public EAttribute getIscrizione_MessaggiErrore() {
		return (EAttribute) iscrizioneEClass.getEStructuralFeatures().get(21);
	}
	...
	public EReference getIscrizione_Allievo() {
		return (EReference) iscrizioneEClass.getEStructuralFeatures().get(22);
	}
	 ...
	 */
	@Override
	public EReference getLezionePratica_StaffIstruttoriLezione() {
		return (EReference) lezionePraticaEClass.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getLezionePratica_LuogoRitrovo() {
		return (EAttribute) lezionePraticaEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getIstruttore_Valutazioni() {
		return (EReference) istruttoreEClass.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getIstruttore_IsAttivo() {
		return (EAttribute) istruttoreEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getSquadra_CapiSquadra() {
	 ...
	 */
	@Override
	public EClass getValutazione() {
		return valutazioneEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getValutazione_MateriaValutazione() {
		return (EAttribute) valutazioneEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getValutazione_TipoEsitoValutazione() {
		return (EAttribute) valutazioneEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getValutazione_IstruttoriValutatori() {
		return (EReference) valutazioneEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getValutazione_Id() {
		return (EAttribute) valutazioneEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EReference getCassa_RipartizioneCassa() {
	 ...
	 */
	@Override
	public EReference getPresenzaLezione_AllievoPresente() {
	 ...
	 */
	@Override
	public EReference getPresenzaLezione_IstruttorePresente() {
	 ...
	 */
	@Override
	public EEnum getETipoDocumento() {
		return eTipoDocumentoEEnum;
	}
	 ...
	 */
	@Override
	public EDataType getDizMateriaValutazione() {
		return dizMateriaValutazioneEDataType;
	}
	...
	public void createPackageContents() {
		...
		createEReference(allievoEClass, ALLIEVO__VALUTAZIONI);
		...
		createEReference(corsoEClass, CORSO__LEZIONI);
		...
		createEAttribute(documentoEClass, DOCUMENTO__TIPO_DOCUMENTO);
		createEAttribute(documentoEClass, DOCUMENTO__DOCUMENTO);
		createEAttribute(documentoEClass, DOCUMENTO__ID);
		...
		createEReference(iscrizioneEClass, ISCRIZIONE__DOCUMENTI);
		...
		createEReference(lezionePraticaEClass, LEZIONE_PRATICA__STAFF_ISTRUTTORI_LEZIONE);
		...
		createEReference(istruttoreEClass, ISTRUTTORE__VALUTAZIONI);
		createEAttribute(istruttoreEClass, ISTRUTTORE__IS_ATTIVO);

		squadraEClass = createEClass(SQUADRA);
		createEReference(squadraEClass, SQUADRA__CAPI_SQUADRA);
		createEReference(squadraEClass, SQUADRA__ALLIEVI_IN_SQUADRA);
		createEAttribute(squadraEClass, SQUADRA__ID);

		valutazioneEClass = createEClass(VALUTAZIONE);
		createEAttribute(valutazioneEClass, VALUTAZIONE__MATERIA_VALUTAZIONE);
		createEAttribute(valutazioneEClass, VALUTAZIONE__TIPO_ESITO_VALUTAZIONE);
		createEReference(valutazioneEClass, VALUTAZIONE__ISTRUTTORI_VALUTATORI);
		createEAttribute(valutazioneEClass, VALUTAZIONE__ID);
		...
		createEReference(cassaEClass, CASSA__RIPARTIZIONE_CASSA);
		...
		createEReference(presenzaLezioneEClass, PRESENZA_LEZIONE__ALLIEVO_PRESENTE);
		createEReference(presenzaLezioneEClass, PRESENZA_LEZIONE__ISTRUTTORE_PRESENTE);
		...
		eTipoDocumentoEEnum = createEEnum(ETIPO_DOCUMENTO);
		...
		dizMateriaValutazioneEDataType = createEDataType(DIZ_MATERIA_VALUTAZIONE);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getAllievo_Valutazioni(), this.getValutazione(), null, "valutazioni", null, 0, -1, Allievo.class,
		...
		initEAttribute(getCorso_QuotaCaparra(), ecorePackage.getEFloatObject(), "quotaCaparra", null, 1, 1, Corso.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCorso_Lezioni(), this.getLezione(), null, "lezioni", null, 1, -1, Corso.class, !IS_TRANSIENT,
		...
		initEClass(documentoEClass, Documento.class, "Documento", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDocumento_TipoDocumento(), this.getETipoDocumento(), "tipoDocumento", null, 1, 1,
				Documento.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDocumento_Documento(), ecorePackage.getEByteArray(), "documento", null, 0, 1, Documento.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDocumento_Id(), ecorePackage.getELongObject(), "id", null, 1, 1, Documento.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getIscrizione_TotaleVersato(), ecorePackage.getEFloatObject(), "totaleVersato", null, 0, 1,
				...
				IS_DERIVED, !IS_ORDERED);
		initEReference(getIscrizione_Documenti(), this.getDocumento(), null, "documenti", null, 0, -1, Iscrizione.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(lezionePraticaEClass, LezionePratica.class, "LezionePratica", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLezionePratica_StaffIstruttoriLezione(), this.getIstruttore(), null, "staffIstruttoriLezione",
				null, 1, -1, LezionePratica.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getIstruttore_Titolo(), this.getETitoloIstruttore(), "titolo", null, 1, 1, Istruttore.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getIstruttore_Valutazioni(), this.getValutazione(), this.getValutazione_IstruttoriValutatori(),
				"valutazioni", null, 1, -1, Istruttore.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSquadra_CapiSquadra(), this.getIstruttore(), null, "capiSquadra", null, 1, -1, Squadra.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(valutazioneEClass, Valutazione.class, "Valutazione", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getValutazione_MateriaValutazione(), this.getDizMateriaValutazione(), "materiaValutazione", null,
				0, 1, Valutazione.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getValutazione_TipoEsitoValutazione(), this.getTipoEsitoValutazione(), "tipoEsitoValutazione",
				null, 0, 1, Valutazione.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getValutazione_IstruttoriValutatori(), this.getIstruttore(), this.getIstruttore_Valutazioni(),
				"istruttoriValutatori", null, 0, -1, Valutazione.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getValutazione_Id(), ecorePackage.getELongObject(), "id", null, 1, 1, Valutazione.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCassa_Totale(), ecorePackage.getEFloat(), "totale", null, 1, 1, Cassa.class, IS_TRANSIENT,
				IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		initEReference(getCassa_RipartizioneCassa(), this.getRipartizioneCassa(), null, "ripartizioneCassa", null, 0,
		...
		initEClass(presenzaLezioneEClass, PresenzaLezione.class, "PresenzaLezione", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPresenzaLezione_AllievoPresente(), this.getAllievo(), null, "allievoPresente", null, 0, -1,
				PresenzaLezione.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPresenzaLezione_IstruttorePresente(), this.getIstruttore(), null, "istruttorePresente", null,
		...
		initEEnum(eTipoDocumentoEEnum, ETipoDocumento.class, "ETipoDocumento");
		addEEnumLiteral(eTipoDocumentoEEnum, ETipoDocumento.CONSENSO_INFORMATO);
		addEEnumLiteral(eTipoDocumentoEEnum, ETipoDocumento.MODULO_ISCRIZIONE);
		addEEnumLiteral(eTipoDocumentoEEnum, ETipoDocumento.CERTIFICATO_MEDICO);
		...
		initEDataType(dizMateriaValutazioneEDataType, String.class, "DizMateriaValutazione", IS_SERIALIZABLE,
				!IS_GENERATED_INSTANCE_CLASS);
