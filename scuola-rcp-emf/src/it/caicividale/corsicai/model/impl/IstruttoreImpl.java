 ...
 *   <li>{@link it.caicividale.corsicai.model.impl.IstruttoreImpl#getValutazioni <em>Valutazioni</em>}</li>
...
public class IstruttoreImpl extends PersonaImpl implements Istruttore {
	...
	public EList<Valutazione> getValutazioni() {
		if (valutazioni == null) {
			valutazioni = new EObjectWithInverseResolvingEList.ManyInverse<Valutazione>(Valutazione.class, this,
					ModelPackage.ISTRUTTORE__VALUTAZIONI, ModelPackage.VALUTAZIONE__ISTRUTTORI_VALUTATORI);
		}
		return valutazioni;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ModelPackage.ISTRUTTORE__VALUTAZIONI:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getValutazioni()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ModelPackage.ISTRUTTORE__VALUTAZIONI:
			return ((InternalEList<?>) getValutazioni()).basicRemove(otherEnd, msgs);
		}
