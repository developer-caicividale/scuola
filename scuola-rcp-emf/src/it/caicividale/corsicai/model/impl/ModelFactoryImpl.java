...
public class ModelFactoryImpl extends EFactoryImpl implements ModelFactory {
	...
	public EObject create(EClass eClass) {
		...
		case ModelPackage.DOCUMENTO:
			return (EObject) createDocumento();
		...
		case ModelPackage.VALUTAZIONE:
			return (EObject) createValutazione();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		...
		case ModelPackage.ETIPO_DOCUMENTO:
			return createETipoDocumentoFromString(eDataType, initialValue);
		...
		case ModelPackage.DIZ_MATERIA_VALUTAZIONE:
			return createDizMateriaValutazioneFromString(eDataType, initialValue);
		default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		...
		case ModelPackage.ETIPO_DOCUMENTO:
			return convertETipoDocumentoToString(eDataType, instanceValue);
		case ModelPackage.ETITOLO_ISTRUTTORE:
		...
		case ModelPackage.DIZ_MATERIA_VALUTAZIONE:
			return convertDizMateriaValutazioneToString(eDataType, instanceValue);
		default:
			throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	...
	public Valutazione createValutazione() {
		ValutazioneImpl valutazione = new ValutazioneImpl();
		return valutazione;
	}
	 ...
	 * @generated
	 */
	public ETipoDocumento createETipoDocumentoFromString(EDataType eDataType, String initialValue) {
		ETipoDocumento result = ETipoDocumento.get(initialValue);
		if (result == null)
			throw new IllegalArgumentException(
					"The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	 ...
	 * @generated
	 */
	public String convertETipoDocumentoToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
	 ...
	 * @generated
	 */
	public String createDizMateriaValutazioneFromString(EDataType eDataType, String initialValue) {
	 ...
	 * @generated
	 */
	public String convertDizMateriaValutazioneToString(EDataType eDataType, Object instanceValue) {
		return super.convertToString(eDataType, instanceValue);
	}
