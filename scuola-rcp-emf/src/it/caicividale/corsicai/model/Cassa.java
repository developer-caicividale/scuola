 ...
 *   <li>{@link it.caicividale.corsicai.model.Cassa#getRipartizioneCassa <em>Ripartizione Cassa</em>}</li>
...
public interface Cassa extends ExternalizableEObject {
	...
	/**
	 * Returns the value of the '<em><b>Ripartizione Cassa</b></em>' reference list.
	 * The list contents are of type {@link it.caicividale.corsicai.model.RipartizioneCassa}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Ripartizione Cassa</em>' reference list.
	 * @see it.caicividale.corsicai.model.ModelPackage#getCassa_RipartizioneCassa()
	 * @model
	 * @generated
	 */
	EList<RipartizioneCassa> getRipartizioneCassa();
